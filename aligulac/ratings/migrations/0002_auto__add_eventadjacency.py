...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventAdjacency'
        db.create_table('eventadjacency', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ratings.Event'], related_name='ancestor')),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ratings.Event'], related_name='descendant')),
            ('distance', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('ratings', ['EventAdjacency'])


    def backwards(self, orm):
        # Deleting model 'EventAdjacency'
        db.delete_table('eventadjacency')
    ...
    models = {
        ...
        'ratings.event': {
            'Meta': {'object_name': 'Event', 'ordering': "['lft']", 'db_table': "'event'"},
            'big': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'category': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '50', 'null': 'True'}),
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ratings.Event']", 'related_name': "'parent_event'", 'null': 'True'}),
        ...
        'ratings.eventadjacency': {
            ...
            'child': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ratings.Event']", 'related_name': "'descendant'"}),
            'distance': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ratings.Event']", 'related_name': "'ancestor'"})
        },
        'ratings.group': {
        ...
        'ratings.match': {
            ...
            'eventobj': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ratings.Event']", 'null': 'True'}),
            ...
            'submitter': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['auth.User']", 'null': 'True'}),
        ...
        'ratings.player': {
            ...
            'country': ('django.db.models.fields.CharField', [], {'blank': 'True', 'db_index': 'True', 'max_length': '2', 'null': 'True'}),
            'dom_end': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ratings.Period']", 'related_name': "'player_dom_end'", 'null': 'True'}),
            'dom_start': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ratings.Period']", 'related_name': "'player_dom_start'", 'null': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'blank': 'True', 'db_index': 'True', 'max_length': '100', 'null': 'True'}),
        ...
        'ratings.prematch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pla': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ratings.Player']", 'related_name': "'prematch_pla'", 'null': 'True'}),
            'pla_string': ('django.db.models.fields.CharField', [], {'blank': 'True', 'default': "''", 'max_length': '200', 'null': 'True'}),
            'plb': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['ratings.Player']", 'related_name': "'prematch_plb'", 'null': 'True'}),
        ...
        'ratings.rating': {
            ...
            'comp_dev': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'comp_dev_vp': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'comp_dev_vt': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
            'comp_dev_vz': ('django.db.models.fields.FloatField', [], {'blank': 'True', 'null': 'True'}),
