...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.current_rating'
        db.add_column('player', 'current_rating',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='current', to=orm['ratings.Rating'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.current_rating'
        db.delete_column('player', 'current_rating_id')
    ...
    models = {
        ...
        'ratings.event': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'blank': 'True', 'max_length': '50', 'null': 'True'}),
