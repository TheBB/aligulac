...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APIKey'
        db.create_table('apikey', (
            ('key', self.gf('django.db.models.fields.CharField')(max_length=20, db_index=True, primary_key=True)),
            ('date_opened', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('ratings', ['APIKey'])


    def backwards(self, orm):
        # Deleting model 'APIKey'
        db.delete_table('apikey')
    ...
    models = {
        ...
        'ratings.event': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'blank': 'True', 'null': 'True'}),
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ratings.Event']", 'blank': 'True', 'related_name': "'parent_event'"}),
        ...
        'ratings.match': {
            ...
            'date': ('django.db.models.fields.DateField', [], {}),
            'event': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True', 'default': "''"}),
        ...
        'ratings.player': {
            ...
            'country': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '2', 'blank': 'True', 'null': 'True'}),
            'current_rating': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ratings.Rating']", 'blank': 'True', 'related_name': "'current'"}),
            'dom_end': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ratings.Period']", 'blank': 'True', 'related_name': "'player_dom_end'"}),
            'dom_start': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ratings.Period']", 'blank': 'True', 'related_name': "'player_dom_start'"}),
        ...
        'ratings.prematch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pla': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ratings.Player']", 'blank': 'True', 'related_name': "'prematch_pla'"}),
            'pla_string': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True', 'default': "''", 'null': 'True'}),
            'plb': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['ratings.Player']", 'blank': 'True', 'related_name': "'prematch_plb'"}),
            'plb_string': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True', 'default': "''", 'null': 'True'}),
        ...
        'ratings.prematchgroup': {
            ...
            'contact': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True', 'default': "''", 'null': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'event': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True', 'default': "''"}),
            ...
            'source': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True', 'default': "''", 'null': 'True'})
        },
        'ratings.rating': {
