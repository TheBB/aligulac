    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eventobj', models.ForeignKey(to='ratings.Event', blank=True, help_text='Event object', verbose_name='Event', null=True, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(to='ratings.Period', verbose_name='Period', help_text='This rating applies to the given period', on_delete=models.CASCADE)),
                ('player', models.ForeignKey(to='ratings.Player', verbose_name='Player', help_text='This rating applies to the given player', on_delete=models.CASCADE)),
                ('prev', models.ForeignKey(to='ratings.Rating', verbose_name='Previous rating', help_text='Previous rating for the same player', related_name='prevrating', null=True, on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['period'],
                'db_table': 'rating',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('placement', models.IntegerField(verbose_name='Place', help_text='Placement')),
                ('event', models.ForeignKey(to='ratings.Event', verbose_name='Event', help_text='Event in which these WCS points was awarded', on_delete=models.CASCADE)),
                ('player', models.ForeignKey(to='ratings.Player', verbose_name='Player', help_text='Player to which these WCS points was awarded', on_delete=models.CASCADE)),
            ],
            options={
                'ordering': ['-points'],
                'db_table': 'wcspoints',
        ...
        migrations.AddField(
            model_name='prematch',
            name='pla',
            field=models.ForeignKey(blank=True, verbose_name='Player A', to='ratings.Player', related_name='prematch_pla', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='prematch',
            name='plb',
            field=models.ForeignKey(blank=True, verbose_name='Player B', to='ratings.Player', related_name='prematch_plb', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='player',
            name='current_rating',
            field=models.ForeignKey(to='ratings.Rating', blank=True, help_text='Current rating', related_name='current', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='player',
            name='dom_end',
            field=models.ForeignKey(to='ratings.Period', blank=True, help_text='End of domination period', related_name='player_dom_end', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='player',
            name='dom_start',
            field=models.ForeignKey(to='ratings.Period', blank=True, help_text='Start of domination period', related_name='player_dom_start', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='message',
            name='player',
        ...
        migrations.AddField(
            model_name='match',
            name='period',
            field=models.ForeignKey(to='ratings.Period', help_text='Period in which the match was played', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='match',
            name='pla',
            field=models.ForeignKey(to='ratings.Player', verbose_name='Player A', help_text='Player A', related_name='match_pla', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='match',
            name='plb',
            field=models.ForeignKey(to='ratings.Player', verbose_name='Player B', help_text='Player B', related_name='match_plb', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='match',
            name='rta',
            field=models.ForeignKey(to='ratings.Rating', verbose_name='Rating A', help_text='Rating for player A at the time the match was played', related_name='rta', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='match',
            name='rtb',
            field=models.ForeignKey(to='ratings.Rating', verbose_name='Rating B', help_text='Rating for player B at the time the match was played', related_name='rtb', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='match',
            name='submitter',
            field=models.ForeignKey(blank=True, verbose_name='Submitter', to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='event',
            name='parent',
            field=models.ForeignKey(to='ratings.Event', blank=True, help_text='Parent event', related_name='parent_event', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='earnings',
            name='event',
            field=models.ForeignKey(to='ratings.Event', verbose_name='Event', help_text='Event in which this prize was awarded', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='earnings',
            name='player',
            field=models.ForeignKey(to='ratings.Player', verbose_name='Player', help_text='Player to which this prize was awarded', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='alias',
            name='group',
