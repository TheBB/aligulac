...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.wcs_year'
        db.add_column('event', 'wcs_year',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'Event.wcs_tier'
        db.add_column('event', 'wcs_tier',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.wcs_year'
        db.delete_column('event', 'wcs_year')

        # Deleting field 'Event.wcs_tier'
        db.delete_column('event', 'wcs_tier')
    ...
    models = {
        ...
        'ratings.earnings': {
            'Meta': {'object_name': 'Earnings', 'ordering': "['-earnings']", 'db_table': "'earnings'"},
        ...
        'ratings.event': {
            ...
            'wcs_tier': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
            'wcs_year': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'})
        },
        ...
        'ratings.story': {
            'Meta': {'object_name': 'Story', 'ordering': "['date']", 'db_table': "'story'"},
            'date': ('django.db.models.fields.DateField', [], {}),
