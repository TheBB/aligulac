...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cluster.min_rating'
        db.alter_column('ratings_cluster', 'min_rating', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Cluster.max_rating'
        db.alter_column('ratings_cluster', 'max_rating', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Cluster.mean_rating'
        db.alter_column('ratings_cluster', 'mean_rating', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Cluster.min_rating'
        db.alter_column('ratings_cluster', 'min_rating', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Cluster.max_rating'
        db.alter_column('ratings_cluster', 'max_rating', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'Cluster.mean_rating'
        db.alter_column('ratings_cluster', 'mean_rating', self.gf('django.db.models.fields.FloatField')(default=0))
    ...
    models = {
        ...
        'ratings.apikey': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '20', 'primary_key': 'True'}),
        ...
        'ratings.cluster': {
            ...
            'max_rating': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'mean_rating': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'min_rating': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
        ...
        'ratings.event': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parent_event'", 'blank': 'True', 'to': "orm['ratings.Event']", 'null': 'True'}),
        ...
        'ratings.player': {
            ...
            'current_rating': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'current'", 'blank': 'True', 'to': "orm['ratings.Rating']", 'null': 'True'}),
            'dom_end': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'player_dom_end'", 'blank': 'True', 'to': "orm['ratings.Period']", 'null': 'True'}),
            'dom_start': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'player_dom_start'", 'blank': 'True', 'to': "orm['ratings.Period']", 'null': 'True'}),
        ...
        'ratings.prematch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pla': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prematch_pla'", 'blank': 'True', 'to': "orm['ratings.Player']", 'null': 'True'}),
            'pla_string': ('django.db.models.fields.CharField', [], {'default': "''", 'blank': 'True', 'null': 'True', 'max_length': '200'}),
            'plb': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prematch_plb'", 'blank': 'True', 'to': "orm['ratings.Player']", 'null': 'True'}),
