...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'ratings.event': {
            'Meta': {'ordering': "['latest', 'fullname']", 'object_name': 'Event', 'db_table': "'event'"},
        ...
        'ratings.player': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100', 'null': 'True', 'db_index': 'True'}),
